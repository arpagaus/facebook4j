...
class FacebookImpl extends FacebookBaseImpl implements Facebook {
    ...
    public InboxResponseList<Conversation> getConversations(String userId) throws FacebookException {
        return getConversations(userId, null);
    }

    public InboxResponseList<Conversation> getConversations(String userId, Reading reading) throws FacebookException {
    	ensureAuthorizationEnabled();
    	return factory.createConversationList(get(buildEndpoint(userId, "conversations", reading)));
    }
